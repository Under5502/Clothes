<?php
    $sql_lietke_anhtrangbia = "SELECT * FROM tbl_anhtrangbia ORDER BY thutu ASC"; // goi tat cả dữ liệu từ tbl danh mục theo thứ tự từ nhỏ đến lớn
    ...
    <table class='lietke_menu' style="    margin-left: 25%;" >
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="./modules/anhtrangbia/xuly.php?idanhtrangbia=<?php echo $row['id_anhtrangbia']?>">Xóa</a>  | 
                     <a href="index.php?action=anhtrangbia&query=sua&idanhtrangbia=<?php echo $row['id_anhtrangbia']?>">Sửa</a> 
