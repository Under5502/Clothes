...
?>
 <!-- tìm kiếm đồ dùng dựa theo từ khóa gần đúng lấy lên từ sql -->
<div class="headline">
...
<div class="maincontent">
            ...
            ?>
             <!-- giá sản phẩm khuyến mãi sẽ bằng giá sản phẩm chính  nhân với % khuyễn mãi chia cho 100 -->
                <ul>
                <div class="maincontent-item">
                        ...
                        <div class="maincontent-info">
                            ...
                            <a href="index.php?quanly=sanpham&id=<?php echo $row_pro['id_sanpham'] ?>" class="maincontent-gia"><?php if($row_pro['km']>0){ echo number_format($giaspkm).'vnd'; }else {echo number_format($row_pro['giasp']).'vnd';} ?>
                             ...
                             <!--lấy sql từ id sản phẩm để tìm kiếm và id sản phẩm phải lớn hơn 0 -->
                                  <!--tạo các button để có thể sử dụng (button là các chỗ để có thể giúp mình click vào) -->
                    </div>
                </ul>
            <?php
                }
